...
const courseGrid = document.getElementById('programList');
const pageNav = document.getElementById('programPagination');
...
function applyCourseFilters() {
    const nameInput = document.getElementById('queryName').value.toLowerCase().trim();
    const levelSelection = document.getElementById('ilterLevel').value;
...
function displayTutorList() {
    const tableBody = document.getElementById('educatorTableBody');
    tableBody.innerHTML = '';
...
function applyTutorFilters() {
    const qualFilter = document.getElementById('certLevel').value;
...
// Row highlighting
document.getElementById('educatorTableBody')?.addEventListener('click', function (e) {
...
// Tutor selection
document.getElementById('educatorTableBody')?.addEventListener('click', (e) => {
...
document.querySelector('#searchCoursesForm button')?.addEventListener('click', applyCourseFilters);
document.querySelector('#filterTutorsForm button')?.addEventListener('click', applyTutorFilters);
